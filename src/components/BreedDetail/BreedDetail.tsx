            ...
            <Flex gap={5} p={4} bg={'#f0f4e4'} width={'100%'}>
                ...
                <Box display={'flex'} flexDirection={'column'} rowGap={2} width={'65%'}>
                    ...
                    <Box display={'flex'} flexDirection={'column'} rowGap={2} >
                        ...
                        <Heading as={'h3'} fontSize={'xl'}>Temperament: <Text color={'blue.400'} fontSize={'md'} as={'span'}>{breed.temperament}.</Text> </Heading>
                        <Heading as={'h3'} fontSize={'xl'}>SpanLife: <Text as={'span'} fontSize={'sm'} >{breed.life_span} years old</Text></Heading>
                        <Heading as={'h3'} fontSize={'xl'}>Weight: <Text as={'span'} fontSize={'sm'} >{breed.weight.metric} kilogram</Text></Heading>
                        <Flex gap={5} flexDirection={'row'} mt={'8px'} alignItems={'center'}>
                            <Heading  as={'h3'} fontSize={'xl'}>More information:</Heading>
                                <Link href={`${breed.wikipedia_url}`} isExternal>
                                <BsWikipedia size={'50px'}/>
                            </Link>
